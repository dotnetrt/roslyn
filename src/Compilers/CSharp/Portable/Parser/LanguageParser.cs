...
tryAgain:
        ...
        private ArgumentSyntax ParseArgumentExpression(bool isIndexer)
        {
            ...
            SyntaxToken refOrOutOrConstKeyword = null;
            ...
            {
                refOrOutOrConstKeyword = this.EatToken();
            }
            ...
            else
            {
                ...
                expression = (refOrOutOrConstKeyword?.Kind == SyntaxKind.OutKeyword)
            ...
            return _syntaxFactory.Argument(nameColon, refOrOutOrConstKeyword, expression);
        }
...
tryAgain:
        ...
        {
            // If we have "ref/out/in/const/params" always try to parse out a type.
            if (hasModifier)
            {
                return true;
            }
